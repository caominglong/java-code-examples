 ...
 *
 * @description: 带参数、带header的GET请求
 * @author: banmao
 * @date: 2022/10/20 10:04
 */
public class GetRequestWithParamAndHeader {
     ...
     * @return
     */
    private CloseableHttpResponse execGetWithParamAndHeader(String uri, Map<String, String> paramMap, Map<String, String> headerMap) {
        System.out.println("============带参数的GET请求，请求uri为" + uri + "============");
        System.out.println("============带参数的GET请求，路径参数为" + JSON.toJSONString(paramMap) + "============");
    ...
    public static void main(String[] args) {
        GetRequestWithParamAndHeader getRequestWithParamAndHeader = new GetRequestWithParamAndHeader();
        ...
        getRequestWithParamAndHeader.execGetWithParamAndHeader(uri, paramMap, headerMap);
    }
}
