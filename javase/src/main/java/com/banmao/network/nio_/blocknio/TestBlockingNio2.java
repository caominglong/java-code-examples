...
public class TestBlockingNio2 {
    ...
    public void client() throws IOException {
        ...
        System.out.println("客户端接收服务端的发送完了！");
    ...
    public void server() throws IOException {
        ...
        // 2、接收客户端数据并保存到本地
        FileChannel fileChannel = FileChannel.open(Paths.get("2.jpeg"), StandardOpenOption.WRITE, StandardOpenOption.CREATE);
        ...
        // 发送反馈
        ByteBuffer put = buffer.put("服务端接收数据成功".getBytes());
        put.flip();
        socketChannel.write(put);

        System.out.println("服务端发送反馈完了！");
